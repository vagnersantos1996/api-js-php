$(document).ready(function() {
    ...
    $(document).on('click', '.update-product-button', function() {
		...
		$.getJSON("http://localhost/api-js-php/product/read_one.php?id="+id, function(data) {
			...
			$.getJSON("http://localhost/api-js-php/category/read.php", function(data) {
	...
	$(document).on('submit', '#update-product-form', function() {
		...
		$.ajax({
			url: "http://localhost/api-js-php/product/update.php",
			type: "POST",
