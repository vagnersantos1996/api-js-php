...
function readProductsTemplate(data, keywords) {
	...
	read_products_html+="<!-- search products form -->";
		...
		read_products_html+="<!-- when clicked, it will load the create product form -->";
		...
		read_products_html+="<!-- start table -->";
		read_products_html+="<table class='table table-bordered table-hover'>";

			read_products_html+="<!-- creating our table heading -->";
		...
		$.each(data.records, function(key, val) {
        	...
        	read_products_html+="<tr>";
				...
				read_products_html+="<!-- 'action' buttons -->";
				read_products_html+="<td class='text-align-center'>";
					read_products_html+="<!-- read product button -->";
					...
					read_products_html+="<!-- edit button -->";
					...
					read_products_html+="<!-- delete button -->";
